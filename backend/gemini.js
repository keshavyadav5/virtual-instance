...
Rules:
- Remove the assistant name from userInput if present.
- If the user asks to search Google or YouTube, userInput must contain ONLY the search query.
...
`;
    ...
    if (error.response?.status === 429) {
      return JSON.stringify({
        type: "general",
        userInput: command,
        response: "I'm a bit busy right now. Please try again."
      });
    }
